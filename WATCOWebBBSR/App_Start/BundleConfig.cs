...
namespace WATCOWebBBSR
{
    public class BundleConfig
    {
        ...
        {
            bundles.Add(new ScriptBundle("~/Scripts/Login/validation").Include(
                "~/Scripts/Account/Login.js"));
        }

        private static void RegisterDashBoard(BundleCollection bundles)
        {
            bundles.Add(new ScriptBundle("~/Scripts/DashBoard/WaterSupply/menu").Include(
                "~/Scripts/Dashboard/dashboard-ws-menu.js"));
            bundles.Add(new ScriptBundle("~/Scripts/DashBoard/WaterSupply/data").Include(
                "~/Scripts/Dashboard/WaterSupply.js"));
            bundles.Add(new ScriptBundle("~/Scripts/DashBoard/Consumer/menu").Include(
                "~/Scripts/Dashboard/dashboard-ci-menu.js"));
            bundles.Add(new ScriptBundle("~/Scripts/DashBoard/Consumer/data").Include(
                "~/Scripts/Dashboard/ConsumerInfo.js"));
            bundles.Add(new ScriptBundle("~/Scripts/DashBoard/AssetOEM/menu").Include(
                "~/Scripts/Dashboard/dashboard-ao-menu.js"));
            bundles.Add(new ScriptBundle("~/Scripts/DashBoard/AssetOEM/data").Include(
                "~/Scripts/Dashboard/AssetOEMActivity.js"));
            bundles.Add(new ScriptBundle("~/Scripts/DashBoard/UserCharge/menu").Include(
                "~/Scripts/Dashboard/dashboard-uc-menu.js"));
            bundles.Add(new ScriptBundle("~/Scripts/DashBoard/UserCharge/data").Include(
                "~/Scripts/Dashboard/UserChargeInfo.js"));
            bundles.Add(new ScriptBundle("~/Scripts/DashBoard/Jalsathi/menu").Include(
                "~/Scripts/Dashboard/dashboard-jp-menu.js"));
            bundles.Add(new ScriptBundle("~/Scripts/DashBoard/Jalsathi/data").Include(
                "~/Scripts/Dashboard/JalsathiPerform.js"));
            bundles.Add(new ScriptBundle("~/Scripts/DashBoard/WaterQuality/menu").Include(
                "~/Scripts/Dashboard/dashboard-wq-menu.js"));
            bundles.Add(new ScriptBundle("~/Scripts/DashBoard/WaterQuality/data").Include(
                "~/Scripts/Dashboard/WaterQualityMonitor.js"));
            bundles.Add(new ScriptBundle("~/Scripts/DashBoard/ConsumerGriev/menu").Include(
                "~/Scripts/Dashboard/dashboard-cg-menu.js"));
            bundles.Add(new ScriptBundle("~/Scripts/DashBoard/ConsumerGriev/data").Include(
                "~/Scripts/Dashboard/ConsumerGrievance.js"));
            bundles.Add(new ScriptBundle("~/Scripts/DashBoard/Container/menu").Include(
                "~/Scripts/Dashboard/dashboard-container-menu.js"));
        }

        private static void RegisterMap(BundleCollection bundles)
        {
            bundles.Add(new StyleBundle("~/Content/Map/OLStyle").Include(
                 "~/Content/Map/OL6.css"));
            bundles.Add(new StyleBundle("~/Content/Map/LSCSS").Include(
                 "~/Content/Map/Layerswitcher3.css"));

            bundles.Add(new ScriptBundle("~/Scripts/Map/OLJS").Include(
                "~/Scripts/Map/OL6.js"));
            bundles.Add(new ScriptBundle("~/Scripts/Map/MapInit").Include(
                "~/Scripts/Map/Index.js"));
            bundles.Add(new ScriptBundle("~/Scripts/Map/MapQuery").Include(
                "~/Scripts/Map/MapQuery.js"));
            bundles.Add(new ScriptBundle("~/Scripts/Map/LSJS").Include(
                "~/Scripts/Map/Layerswitcher3.js"));
            bundles.Add(new ScriptBundle("~/Scripts/Map/JSONParser").Include(
                "~/Scripts/Map/JSONParserForMapLayers.js"));
            bundles.Add(new ScriptBundle("~/Scripts/Map/ModalPop").Include(
                "~/Scripts/Map/ModalMap.js"));
            bundles.Add(new ScriptBundle("~/Scripts/Map/Menu").Include(
                 "~/Scripts/Map/Map-menu.js"));
        }

        private static void RegisterMIS(BundleCollection bundles)
        {
            bundles.Add(new ScriptBundle("~/Scripts/MIS/Consumer/menu").Include(
                "~/Scripts/MIS/mis-ci-menu.js"));
            bundles.Add(new ScriptBundle("~/Scripts/MIS/Consumer/data").Include(
                "~/Scripts/MIS/ConsumerInfo.js"));
            bundles.Add(new ScriptBundle("~/Scripts/MIS/ConsumerBill/menu").Include(
                "~/Scripts/MIS/mis-cb-menu.js"));
            bundles.Add(new ScriptBundle("~/Scripts/MIS/ConsumerBill/data").Include(
                "~/Scripts/MIS/ConsumerBillInfo.js"));
            bundles.Add(new ScriptBundle("~/Scripts/MIS/Asset/menu").Include(
                "~/Scripts/MIS/mis-as-menu.js"));
            bundles.Add(new ScriptBundle("~/Scripts/MIS/Asset/data").Include(
                "~/Scripts/MIS/AssetInfo.js"));
        }
