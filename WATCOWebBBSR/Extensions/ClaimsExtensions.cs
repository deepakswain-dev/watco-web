...
namespace WATCOWebBBSR.Extensions
{
    public static class ClaimsExtensions
    {
        static string GetUserEmail(this ClaimsIdentity identity)
        {
            return identity.Claims?.FirstOrDefault(c => c.Type == "WATCOWebBBSR.Models.RegisterViewModel.Email")?.Value;
        }
        ...
        {
            return identity.Claims?.FirstOrDefault(c => c.Type == "WATCOWebBBSR.Models.RegisterViewModel.NameIdentifier")?.Value;
        }
